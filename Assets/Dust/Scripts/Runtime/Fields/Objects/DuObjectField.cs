...
namespace DustEngine
{
    ...
    {
        protected static readonly Color k_GizmosColorRangeZero = new Color(0.00f, 0.50f, 0.66f);
        protected static readonly Color k_GizmosColorRangeOne = new Color(0.00f, 0.75f, 1.00f);
