...
namespace DustEngine
{
    ...
    public class ActivateAction : InstantAction
    {
        ...
        protected bool GetNewState(bool currentState)
        {
            ...
            {
                case ActivationMode.Disable:       return false;
                case ActivationMode.Enable:        return true;
                case ActivationMode.Toggle:        return !currentState;
                case ActivationMode.ToggleRandom:  return duRandom.Next() >= 0.5f;
